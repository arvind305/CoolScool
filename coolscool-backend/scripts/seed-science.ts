...
const SCIENCE_SUBJECTS: SubjectConfig[] = [
  {
    ...
    subjectName: 'Science',
    classRange: [1, 5],
    topicFilePattern: (cls) => `_class${cls}_science_topics.json`,
  ...
  },
  {
    ...
    subjectName: 'Physics',
    classRange: [6, 10],
    topicFilePattern: (cls) => `_class${cls}_physics_topics.json`,
  ...
  },
  {
    ...
    classRange: [6, 10],
    topicFilePattern: (cls) => `_class${cls}_chemistry_topics.json`,
  ...
  },
  {
    ...
    subjectName: 'Biology',
    classRange: [6, 10],
    topicFilePattern: (cls) => `_class${cls}_biology_topics.json`,
